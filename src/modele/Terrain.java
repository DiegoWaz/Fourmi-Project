...
public class Terrain {
	...
	/** 
	 * initialise les zones de nourriture :
	...
	private void initObstacle(){
		setObstacle((taille ) / 4, (8*taille) / 6, 2,2); // 0 = carr� ou rectangle / 1 = losange / 2 = forme random
	...
	/**pose le nid sur le terrain, d�finit l'odeur du nid dans chaque case du terrain*/
	 ...
	 * c'est � dire de diffuser de la ph�romone et d'en �vaporer une partie
	 */
